...
from zmusic.picard.formats.id3 import (
    MP3File,
    TrueAudioFile,
    )
...
from zmusic.picard.formats.apev2 import (
    MonkeysAudioFile,
    MusepackFile,
    OptimFROGFile,
    WavPackFile,
...
from zmusic.picard.formats.vorbis import (
    FLACFile,
    OggFLACFile,
    OggSpeexFile,
    OggVorbisFile,
...
try:
    from zmusic.picard.formats.mp4 import MP4File
    register_format(MP4File)
except ImportError:
    pass

try:
    from zmusic.picard.formats.asf import ASFFile
    register_format(ASFFile)
except ImportError:
    pass

from zmusic.picard.formats.wav import WAVFile
